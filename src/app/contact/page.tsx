        ...
        <section className="py-8 sm:py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-gray-500 text-base sm:text-lg max-w-2xl mx-auto">
              Vous avez une question ou besoin d'aide pour votre réservation ?
                    ...
                    <div className="flex gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          2ème étage B25, Immeuble le Montplaisir
                          <br />
                          Avenue Kheireddine Pacha, Rue Omar Kaddeh
                          <br />
                          Tunis 1073
                        </p>
                      </div>
                    ...
                    <div className="flex gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <a
                            href="#"
                            className="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 rounded-lg text-sm transition-colors"
                          >
                          ...
                          >
                            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 19.5c-1.5 0-2.9-.4-4.1-1.1l-3.1 1.1.6-3.1C4.7 15.5 4.1 13.8 4.1 12c0-4.1 3.4-7.5 7.5-7.5s7.5 3.4 7.5 7.5-3.4 7.5-7.5 7.5z"/>
                            </svg>
                            Messenger
                          </a>
                        </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm text-gray-600 bg-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        />
                      </div>
                      <div>
                        <label
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm text-gray-600 bg-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 font-medium text-sm transition-colors"
                    >
